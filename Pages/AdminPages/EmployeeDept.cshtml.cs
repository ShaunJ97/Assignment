...
{
    public class EmployeeDeptModel : PageModel
    {
        ...
        public EmployeeDeptModel(IWebHostEnvironment env)
        {
            _env = env;
        }
        ...
        public IActionResult OnGet(string pdf)
        {
            ...
            using (SqlCommand command = new SqlCommand())
            {
                ...
                command.CommandText = @"SELECT * FROM EmployeesTable;";
                ...
                while (reader.Read())
                {
                    ...
                    Row.EmployeeLastName = reader.GetString(2);
                    Row.EmployeeDoB = reader.GetDateTime(3);
                    Row.EmployeeDateHired = reader.GetDateTime(4);
                    Employee.Add(Row);
                }
            ...
            if (pdf == "1")
            {
                ...
                cell = row.Cells[2];
                cell.AddParagraph("Employee Last Name");
                cell = row.Cells[3];
                ...
                for (int i = 0; i < Employee.Count; i++)
                {
                    ...
                    cell = row.Cells[2];
                    cell.AddParagraph(Employee[i].EmployeeLastName);
                    cell = row.Cells[3];
                ...
                tab.SetEdge(0, 0, 5, (Employee.Count + 1), Edge.Box, BorderStyle.Single, 1.5, Colors.Black);
                sec.Add(tab);
